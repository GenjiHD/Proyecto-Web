...
import { useRegistros } from '../controllers/useRegistros';
import { RegistrosSchema } from '../schemas/RegistrosSchemas';
...
const getPersonal = async () => {
  try {
    ...
    console.log('Error al obtener el personal');
  }
};
...
watch(mensaje, () => {
  if (mensaje.value && mensaje.value[0] === 'Registro agregado con éxito') {
    ...
    console.log('No se puede ingresar este registro');
  }
});
</script>
